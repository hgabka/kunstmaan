 ...
 */
class Version20160810200059 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE kuma_users (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, username_canonical VARCHAR(180) NOT NULL, email VARCHAR(180) NOT NULL, email_canonical VARCHAR(180) NOT NULL, enabled TINYINT(1) NOT NULL, salt VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, last_login DATETIME DEFAULT NULL, locked TINYINT(1) NOT NULL, expired TINYINT(1) NOT NULL, expires_at DATETIME DEFAULT NULL, confirmation_token VARCHAR(255) DEFAULT NULL, password_requested_at DATETIME DEFAULT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', credentials_expired TINYINT(1) NOT NULL, credentials_expire_at DATETIME DEFAULT NULL, admin_locale VARCHAR(5) DEFAULT NULL, password_changed TINYINT(1) DEFAULT NULL, google_id VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_39EF0B8692FC23A8 (username_canonical), UNIQUE INDEX UNIQ_39EF0B86A0D96FBF (email_canonical), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE kuma_form_submission_fields (id BIGINT AUTO_INCREMENT NOT NULL, form_submission_id BIGINT DEFAULT NULL, fieldName VARCHAR(255) NOT NULL, `label` VARCHAR(255) NOT NULL, sequence INT DEFAULT NULL, discr VARCHAR(255) NOT NULL, sfsf_value VARCHAR(255) DEFAULT NULL, tfsf_value LONGTEXT DEFAULT NULL, bfsf_value TINYINT(1) DEFAULT NULL, cfsf_value LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', expanded TINYINT(1) DEFAULT NULL, multiple TINYINT(1) DEFAULT NULL, choices LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', required TINYINT(1) DEFAULT NULL, ffsf_value VARCHAR(255) DEFAULT NULL, uuid VARCHAR(255) DEFAULT NULL, url VARCHAR(255) DEFAULT NULL, efsf_value VARCHAR(255) DEFAULT NULL, INDEX IDX_A0B2BD32422B0E0C (form_submission_id), UNIQUE INDEX UNIQ_A0B2BD32D17F50A6 (uuid), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE webtown_kunstmaan_gallery_page_parts (id BIGINT AUTO_INCREMENT NOT NULL, folder_id BIGINT NOT NULL, INDEX IDX_5BCE19EB162CB942 (folder_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE webtown_kunstmaanextensionbundle_insert_page_page_parts (id BIGINT AUTO_INCREMENT NOT NULL, node_id BIGINT DEFAULT NULL, INDEX IDX_ACAE726C460D9FD7 (node_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE webtown_kunstmaan_slider_page_parts (id BIGINT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE webtown_kunstmaan_slider_image (id BIGINT AUTO_INCREMENT NOT NULL, slider_page_part_id BIGINT DEFAULT NULL, media_id BIGINT DEFAULT NULL, caption_title VARCHAR(255) DEFAULT NULL, caption VARCHAR(255) DEFAULT NULL, alt_text VARCHAR(255) DEFAULT NULL, link VARCHAR(255) DEFAULT NULL, open_in_new_window TINYINT(1) DEFAULT NULL, display_order INT UNSIGNED NOT NULL COMMENT \'Sorting\', INDEX IDX_56EBE6579C9545AB (slider_page_part_id), INDEX IDX_56EBE657EA9FDD75 (media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE kumatest_publicbundle_to_top_page_parts (id BIGINT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE kumatest_publicbundle_image_page_parts (id BIGINT AUTO_INCREMENT NOT NULL, media_id BIGINT DEFAULT NULL, caption VARCHAR(255) DEFAULT NULL, alt_text VARCHAR(255) DEFAULT NULL, link VARCHAR(255) DEFAULT NULL, open_in_new_window TINYINT(1) DEFAULT NULL, INDEX IDX_28F5D9B8EA9FDD75 (media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE kumatest_publicbundle_button_page_parts (id BIGINT AUTO_INCREMENT NOT NULL, link_text VARCHAR(255) DEFAULT NULL, link_url VARCHAR(255) DEFAULT NULL, link_new_window TINYINT(1) DEFAULT NULL, type VARCHAR(15) DEFAULT NULL, size VARCHAR(15) DEFAULT NULL, position VARCHAR(15) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE kumatest_publicbundle_audio_page_parts (id BIGINT AUTO_INCREMENT NOT NULL, media_id BIGINT DEFAULT NULL, INDEX IDX_447F9F83EA9FDD75 (media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE kumatest_publicbundle_toc_page_parts (id BIGINT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE kumatest_publicbundle_video_page_parts (id BIGINT AUTO_INCREMENT NOT NULL, video_media_id BIGINT DEFAULT NULL, thumbnail_media_id BIGINT DEFAULT NULL, caption VARCHAR(255) DEFAULT NULL, INDEX IDX_C48CD638421DEFC9 (video_media_id), INDEX IDX_C48CD638C364B086 (thumbnail_media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE kumatest_publicbundle_download_page_parts (id BIGINT AUTO_INCREMENT NOT NULL, media_id BIGINT DEFAULT NULL, INDEX IDX_8C326636EA9FDD75 (media_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE kumatest_publicbundle_header_page_parts (id BIGINT AUTO_INCREMENT NOT NULL, niv INT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE kumatest_publicbundle_raw_html_page_parts (id BIGINT AUTO_INCREMENT NOT NULL, content LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE kumatest_publicbundle_text_page_parts (id BIGINT AUTO_INCREMENT NOT NULL, content LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE kumatest_publicbundle_link_page_parts (id BIGINT AUTO_INCREMENT NOT NULL, url VARCHAR(255) DEFAULT NULL, text VARCHAR(255) DEFAULT NULL, open_in_new_window TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE kumatest_publicbundle_line_page_parts (id BIGINT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE kumatest_publicbundle_intro_text_page_parts (id BIGINT AUTO_INCREMENT NOT NULL, content LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE kumatest_publicbundle_behat_test_pages (id BIGINT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, page_title VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE kumatest_publicbundle_content_pages (id BIGINT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, page_title VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE kumatest_publicbundle_home_pages (id BIGINT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, page_title VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE webtown_kunstmaan_gallery_page_parts ADD CONSTRAINT FK_5BCE19EB162CB942 FOREIGN KEY (folder_id) REFERENCES kuma_folders (id)');
        $this->addSql('ALTER TABLE webtown_kunstmaanextensionbundle_insert_page_page_parts ADD CONSTRAINT FK_ACAE726C460D9FD7 FOREIGN KEY (node_id) REFERENCES kuma_nodes (id)');
        $this->addSql('ALTER TABLE webtown_kunstmaan_slider_image ADD CONSTRAINT FK_56EBE6579C9545AB FOREIGN KEY (slider_page_part_id) REFERENCES webtown_kunstmaan_slider_page_parts (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE webtown_kunstmaan_slider_image ADD CONSTRAINT FK_56EBE657EA9FDD75 FOREIGN KEY (media_id) REFERENCES kuma_media (id)');
        $this->addSql('ALTER TABLE kumatest_publicbundle_image_page_parts ADD CONSTRAINT FK_28F5D9B8EA9FDD75 FOREIGN KEY (media_id) REFERENCES kuma_media (id)');
        $this->addSql('ALTER TABLE kumatest_publicbundle_audio_page_parts ADD CONSTRAINT FK_447F9F83EA9FDD75 FOREIGN KEY (media_id) REFERENCES kuma_media (id)');
        $this->addSql('ALTER TABLE kumatest_publicbundle_video_page_parts ADD CONSTRAINT FK_C48CD638421DEFC9 FOREIGN KEY (video_media_id) REFERENCES kuma_media (id)');
        $this->addSql('ALTER TABLE kumatest_publicbundle_video_page_parts ADD CONSTRAINT FK_C48CD638C364B086 FOREIGN KEY (thumbnail_media_id) REFERENCES kuma_media (id)');
        $this->addSql('ALTER TABLE kumatest_publicbundle_download_page_parts ADD CONSTRAINT FK_8C326636EA9FDD75 FOREIGN KEY (media_id) REFERENCES kuma_media (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE webtown_kunstmaanextensionbundle_insert_page_page_parts DROP FOREIGN KEY FK_ACAE726C460D9FD7');
        ...
        $this->addSql('ALTER TABLE webtown_kunstmaan_gallery_page_parts DROP FOREIGN KEY FK_5BCE19EB162CB942');
        ...
        $this->addSql('ALTER TABLE webtown_kunstmaan_slider_image DROP FOREIGN KEY FK_56EBE657EA9FDD75');
        $this->addSql('ALTER TABLE kumatest_publicbundle_image_page_parts DROP FOREIGN KEY FK_28F5D9B8EA9FDD75');
        $this->addSql('ALTER TABLE kumatest_publicbundle_audio_page_parts DROP FOREIGN KEY FK_447F9F83EA9FDD75');
        $this->addSql('ALTER TABLE kumatest_publicbundle_video_page_parts DROP FOREIGN KEY FK_C48CD638421DEFC9');
        $this->addSql('ALTER TABLE kumatest_publicbundle_video_page_parts DROP FOREIGN KEY FK_C48CD638C364B086');
        $this->addSql('ALTER TABLE kumatest_publicbundle_download_page_parts DROP FOREIGN KEY FK_8C326636EA9FDD75');
        ...
        $this->addSql('ALTER TABLE webtown_kunstmaan_slider_image DROP FOREIGN KEY FK_56EBE6579C9545AB');
        ...
        $this->addSql('DROP TABLE webtown_kunstmaan_gallery_page_parts');
        $this->addSql('DROP TABLE webtown_kunstmaanextensionbundle_insert_page_page_parts');
        $this->addSql('DROP TABLE webtown_kunstmaan_slider_page_parts');
        $this->addSql('DROP TABLE webtown_kunstmaan_slider_image');
        $this->addSql('DROP TABLE kumatest_publicbundle_to_top_page_parts');
        $this->addSql('DROP TABLE kumatest_publicbundle_image_page_parts');
        $this->addSql('DROP TABLE kumatest_publicbundle_button_page_parts');
        $this->addSql('DROP TABLE kumatest_publicbundle_audio_page_parts');
        $this->addSql('DROP TABLE kumatest_publicbundle_toc_page_parts');
        $this->addSql('DROP TABLE kumatest_publicbundle_video_page_parts');
        $this->addSql('DROP TABLE kumatest_publicbundle_download_page_parts');
        $this->addSql('DROP TABLE kumatest_publicbundle_header_page_parts');
        $this->addSql('DROP TABLE kumatest_publicbundle_raw_html_page_parts');
        $this->addSql('DROP TABLE kumatest_publicbundle_text_page_parts');
        $this->addSql('DROP TABLE kumatest_publicbundle_link_page_parts');
        $this->addSql('DROP TABLE kumatest_publicbundle_line_page_parts');
        $this->addSql('DROP TABLE kumatest_publicbundle_intro_text_page_parts');
        $this->addSql('DROP TABLE kumatest_publicbundle_behat_test_pages');
        $this->addSql('DROP TABLE kumatest_publicbundle_content_pages');
        $this->addSql('DROP TABLE kumatest_publicbundle_home_pages');
