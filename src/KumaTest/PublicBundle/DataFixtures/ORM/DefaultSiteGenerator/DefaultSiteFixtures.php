...
namespace KumaTest\PublicBundle\DataFixtures\ORM\DefaultSiteGenerator;

use Doctrine\Common\DataFixtures\AbstractFixture;
use Doctrine\Common\DataFixtures\OrderedFixtureInterface;
use Doctrine\Common\Persistence\ObjectManager;
use KumaTest\PublicBundle\Entity\Pages\ContentPage;
use KumaTest\PublicBundle\Entity\Pages\HomePage;
...
class DefaultSiteFixtures extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface
{
    ...
    private function createContentPages()
    {
        ...
        $homePage = $nodeRepo->findOneBy(['internalName' => 'homepage']);
        ...
        $translations = [];
        foreach ($this->requiredLocales as $locale) {
            $translations[] = ['language' => $locale, 'callback' => function ($page, $translation, $seo) use ($locale) {
    ...
    private function createMedia()
    {
        ...
        $imageFolder = $this->manager->getRepository('KunstmaanMediaBundle:Folder')->findOneBy(['rel' => 'image']);
        $filesFolder = $this->manager->getRepository('KunstmaanMediaBundle:Folder')->findOneBy(['rel' => 'files']);
    ...
    $videoFolder = $this->manager->getRepository('KunstmaanMediaBundle:Folder')->findOneBy(['rel' => 'video']);
