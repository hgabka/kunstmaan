 ...
 * ButtonPagePart
 *
 * @ORM\Table(name="kumatest_publicbundle_button_page_parts")
 * @ORM\Entity
 */
class ButtonPagePart extends AbstractPagePart
{
    ...
    {
        return 'KumaTestPublicBundle:PageParts:ButtonPagePart/view.html.twig';
    }

    /**
     * Get the admin form type.
     *
     * @return \KumaTest\PublicBundle\Form\PageParts\ButtonPagePartAdminType
     */
    public function getDefaultAdminType()
    {
        return new \KumaTest\PublicBundle\Form\PageParts\ButtonPagePartAdminType();
    }
}
