 ...
 *
 * @ORM\Entity
 * @ORM\Table(name="kumatest_publicbundle_image_page_parts")
 */
class ImagePagePart extends AbstractPagePart
{
    ...
    {
	return 'KumaTestPublicBundle:PageParts:ImagePagePart/view.html.twig';
    }

    /**
     * Get the admin form type.
     *
     * @return \KumaTest\PublicBundle\Form\PageParts\ImagePagePartAdminType
     */
    public function getDefaultAdminType()
    {
	return new \KumaTest\PublicBundle\Form\PageParts\ImagePagePartAdminType();
    }
}
